...
<div class="mb-3">
                    <label for="text" class="form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="alamat" rows="5" required="" placeholder="Masukkan alamat lokasi aset.."></textarea>
                    </div>
<div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="ps-3 pe-3" action="/editkendaraandanambulance" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                    <label for="text" class="form-label">Kondisi</label>
                        <textarea class="form-control" name="kondisi" id="nameedit9" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang kondisi aset.."></textarea>
...
<div class="mb-3">
                    <label for="text" class="form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="nameedit15" rows="5" required="" placeholder="Masukkan alamat aset.."></textarea>
...
<div class="mb-3">
                    <label for="text" class="form-label">Keterangan</label>
                    <textarea class="form-control" name="keterangan" id="nameedit16" rows="5" placeholder="Masukkan keterangan aset.."></textarea>
