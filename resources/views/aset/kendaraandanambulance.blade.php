...
<body class="loading" data-layout="topnav"
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                            ...
                            <div class="page-title-box">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb bg-light-lighten p-2">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Kendaraan dan Ambulance
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="text-sm-end">
                                                    <a href="../exportasetkendaraandanambulance"> <button
                                                            type="button" class="btn btn-danger mb-2 me-1"><i
                                                    ...
                                                    <button type="button" data-bs-toggle="modal"
                                                        data-bs-target="#addkendaraandanambulance"
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane show active" id="buttons-table-preview">
                                                    ...
                                                    <table id="datatable-buttons"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="table-action">
                                                                    <a data-bs-toggle="modal"
                                                                        data-bs-target="#previewkendaraandanambulance-<?= $user->id_kendaraandanambulance ?>"
                                                                        data-id='<?= $user->id_kendaraandanambulance ?>'
                                                                        class="action-icon"> <i
                                                        ...
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <a onclick="loaddata(<?= $nourut ?>);"
                                                                        ...
                                                                        data-bs-target="#editkendaraandanambulance"
                                                                        class="action-icon"
                                                                        id="editbutton-<?= $nourut ?>"
                                                                        data-petugasdua='<?= $user->id_petugas2 ?>'
                                                                        data-id='<?= $user->id_kendaraandanambulance ?>'
                                                                        data-nama='<?= $user->nama_kendaraandanambulance ?>'
                                                                        data-jenis='<?= $jenis ?>'
                                                                    ...
                                                                    <a onclick="return swallnya(<?= $user->id_kendaraandanambulance ?>)"
                                                        ...
                                                        ?>
                                                                    <a target="_blank"
                                                                        href="../qrasetkendaraandanambulance/<?= $tanggalbarang->format('Y') ?>/<?= $tanggalbarang->format('m') ?>/<?= $user->kode_aset_kendaraandanambulance ?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?= $no ?>/<?= str_replace('/', ' atau ', $user->nama_kendaraandanambulance) ?>/<?= str_replace('/', ' atau ', $jenis) ?>/<?= str_replace('/', ' atau ', $nopol) ?>/<?= str_replace('/', ' atau ', $merek) ?>/<?= str_replace('/', ' atau ', $ket) ?>"
                                                                        class="action-icon"> <i
                                                                            class="mdi mdi-qrcode"></i></a>
                                                                </td>
                                                                </td>
                                                                <!-- Preview Modal -->
                                                                <div id="previewkendaraandanambulance-<?= $user->id_kendaraandanambulance ?>"
                                                                                ...
                                                                                <div class="row mt-4">
                                                                                    <div class="col-sm-4">
                                                                                        <p class="text"><strong>Nama
                                                                                                Aset/Kendaraan
                                                                                                :</strong> <span
                                                                                                class="ms-1"><?= $user->nama_kendaraandanambulance ?></span>
                                                                                        </p>
                                                                                        ...
                                                                                        <p class="text"><strong>Kode
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->kode_aset_kendaraandanambulance ?></span>
                                                                                        </p>

                                                                                        <p class="text"><strong>No
                                                                                                Polisi :</strong> <span
                                                                                                class="ms-1"><?= $nopol ?></span>
                                                                                        </p>
                                                                                        <p class="text">
                                                                                            <strong>Kepemilikan/STNK
                                                                                                :</strong> <span
                                                                                                class="ms-1"><?= $user->kepemilikan_stnk ?></span>
                                                                                        </p>
                                                                                        ...
                                                                                        <p class="text"><strong>No
                                                                                                Mesin :</strong> <span
                                                                                                class="ms-1"><?= $user->nomesin ?></span>
                                                                                        </p>

                                                                                        <p class="text"><strong>No
                                                                                                BPKB :</strong><span
                                                                                                class="ms-1"><?= $user->nobpkb ?></span>
                                                                                        </p>
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        ...
                                                                                        <p class="text"><strong>Masa Manfaat :</strong>
                                                                                            <?php if (!empty($user->masa_manfaat)): ?>
                                                                                                <span class="ms-1"><?= $user->masa_manfaat ?> Tahun</span>
                                                                                            <?php endif; ?>
                                                                                            </p>                                                                                            
                                                                                        <p class="text"><strong>Penyusutan :</strong>
                                                                                            <?php if (!empty($user->penyusutan)): ?>
                                                                                                <span class="ms-1">Rp.
                                                                                                    <?= number_format($user->penyusutan, 2, ',', '.') ?> /Tahun</span>
                                                                                            <?php endif; ?>
                                                                                            </p>                                                                                            
                                                                                        <p class="text">
                                                                                            <strong>Tanggal Aset
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="addkendaraandanambulance" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/addkendaraandanambulance" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Aset/Kendaraan</label>
                                    <input class="form-control" name="nama_kendaraandanambulance" type="text"
                                        id="nama_kendaraandanambulance" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Kendaraan</label>
                                    <input class="form-control" name="jenis_kendaraan"
                                        style="text-transform:uppercase;" type="text" id="jenis_kendaraan"
                                        required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Merek</label>
                                    <input class="form-control" name="merek_kendaraan" type="text"
                                        id="	merek_kendaraan" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="nopol" type="text"
                                        style="text-transform:uppercase;" id="nopol" required=""
                                        placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nomor Rangka</label>
                                    <input class="form-control" name="norangka" type="text"
                                        style="text-transform:uppercase;" id="norangka" required=""
                                        placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nomor Mesin</label>
                                    <input class="form-control" name="nomesin" type="text"
                                        style="text-transform:uppercase;" id="nomesin" required=""
                                        placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nomor BPKB</label>
                                    <input class="form-control" name="nobpkb" type="text"
                                        style="text-transform:uppercase;" id="nobpkb" required=""
                                        placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Kepemilikan/STNK</label>
                                    <input class="form-control" name="kepemilikan_stnk" type="text"
                                        id="kepemilikan_stnk" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Kondisi</label>
                                    <textarea class="form-control" name="kondisi" id="kondisi" required="" rows="5"
                                        placeholder="Masukkan beberapa ringkasan tentang kondisi Aset/Kendaraan.."></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="alamat" id="alamat" rows="5" required=""
                                        placeholder="Masukkan alamat lokasi Aset/Kendaraan.."></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="keterangan" id="keterangan" rows="5"
                                        placeholder="Masukkan keterangan Aset/Kendaraan.."></textarea>
                                </div>
                        </div>
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="editkendaraandanambulance" tabindex="-1" role="dialog"
                aria-labelledby="scrollableModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/editkendaraandanambulance" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Kendaraan</label>
                                    <input class="form-control" name="jenis_kendaraan"
                                        style="text-transform:uppercase;" type="text" id="nameedit2"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Merek</label>
                                    <input class="form-control" name="merek_kendaraan" type="text" id="nameedit3"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nomor Polisi</label>
                                    <input class="form-control" name="nopol" type="text"
                                        style="text-transform:uppercase;" id="nameedit4" required=""
                                        placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nomor Rangka</label>
                                    <input class="form-control" name="norangka" type="text"
                                        style="text-transform:uppercase;" id="nameedit5" required=""
                                        placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nomor Mesin</label>
                                    <input class="form-control" name="nomesin" type="text"
                                        style="text-transform:uppercase;" id="nameedit6" required=""
                                        placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nomor BPKB</label>
                                    <input class="form-control" name="nobpkb" style="text-transform:uppercase;"
                                        type="text" id="nameedit7" required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Kepemilikan/STNK</label>
                                    <input class="form-control" name="kepemilikan_stnk" type="text"
                                        id="nameedit8" required="" placeholder="">
                                    <input class="form-control" name="id" type="hidden" id="idedit8"
                                        required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Kondisi</label>
                                    <textarea class="form-control" name="kondisi" id="nameedit9" required="" rows="5"
                                        placeholder="Masukkan beberapa ringkasan tentang kondisi Aset/Kendaraan.."></textarea>
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jumlah</label>
                                    <input class="form-control" name="jumlah" type="number" id="nameedit10"
                                        required="" value="1" readonly>
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Satuan</label>
                                    <input class="form-control" name="satuan" type="text" id="nameedit11"
                                        required="" value="Unit" readonly>
                                    <input class="form-control" name="id" type="hidden" id="idedit11"
                                        required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nilai Perolehan Aset</label>
                                    <input class="form-control" name="nilaiperolehan" type="number" id="nameedit12"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Tanggal Aset</label>
                                    <input class="form-control" name="tanggal_aset" type="date" id="nameedit13"
                                        required="" placeholder="">
                                ...
                                <div class="fallback">
                                    <label for="image" class="form-label">Foto Aset/Kendaraan</label>
                                    <input type="file" class="form-control" id="nameedit14"
                                        accept="image/jpeg, image/jpg, image/gif, image/png" name="image">
                                    <input class="form-control" name="id" id="idedit14" type="hidden"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Alamat</label>
                                    <textarea class="form-control" name="alamat" id="nameedit15" rows="5" required=""
                                        placeholder="Masukkan alamat Aset/Kendaraan.."></textarea>
                                    <input class="form-control" name="id" type="hidden" id="idedit15"
                                        required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Pengelola Barang</label>
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Keterangan</label>
                                    <textarea class="form-control" name="keterangan" id="nameedit16" rows="5"
                                        placeholder="Masukkan keterangan Aset/Kendaraan.."></textarea>
                                    <input class="form-control" name="id" type="hidden" id="idedit16"
                                        required="" placeholder="">
                                </div>
                        </div>
                        <div class="modal-footer">
