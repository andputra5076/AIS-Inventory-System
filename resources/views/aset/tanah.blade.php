...
<body class="loading" data-layout="topnav"
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="text-sm-end">
                                                    <a href="../exportasettanah"> <button type="button"
                                                    ...
                                                    <table id="datatable-buttons"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="table-action">
                                                                    <a data-bs-toggle="modal"
                                                                        data-bs-target="#previewtanah-<?= $user->id_tanah ?>"
                                                                        data-id='<?= $user->id_tanah ?>'
                                                                        class="action-icon"> <i
                                                        ...
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <a onclick="return swallnya(<?= $user->id_tanah ?>)"
                                                        ...
                                                        ?>
                                                                    <a target="_blank"
                                                                        href="../qrtanah/<?= $tanggalbarang->format('Y') ?>/<?= $tanggalbarang->format('m') ?>/<?= $user->kode_aset_tanah ?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?= $no ?>/<?= $user->nama_tanah ?>/<?= str_replace('/', ' atau ', $objek) ?>/<?= str_replace('/', ' atau ', $jenis) ?>/<?= str_replace('/', ' atau ', $luas) ?>/<?= str_replace('/', ' atau ', $latitude) ?>/<?= str_replace('/', ' atau ', $longitude) ?>/<?= str_replace('/', ' atau ', $ket) ?>"
                                                                        class="action-icon"> <i
                                                                            class="mdi mdi-qrcode"></i></a>
                                                                </td>
                                                                </td>
                                                                <!-- Preview Modal -->
                                                                <div id="previewtanah-<?= $user->id_tanah ?>"
                                                                                ...
                                                                                <div class="row mt-4">
                                                                                    <div class="col-sm-4">
                                                                                        <p class="text"><strong>Nama
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->nama_tanah ?></span>
                                                                                        </p>
                                                                                        <p class="text"><strong>Nama
                                                                                                Objek :</strong> <span
                                                                                        ...
                                                                                        <p class="text"><strong>Kode
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->kode_aset_tanah ?></span>
                                                                                        </p>
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="addtanah" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/addtanah" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="nama_tanah" type="text" id="nama_tanah"
                                        value="Aset Tetap Tanah" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Objek</label>
                                    <input class="form-control" name="nama_objek" style="text-transform:uppercase;"
                                        type="text" id="nama_objek" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Tanah</label>
                                    <input class="form-control" name="jenis_tanah" type="text" id="	jenis_tanah"
                                        placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Luas Tanah</label>
                                    <input class="form-control" name="luas_tanah" type="text" id="	luas_tanah"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="kondisi" id="kondisi" required="" rows="5"
                                        placeholder="Masukkan beberapa ringkasan tentang kondisi Tanah.."></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="alamat" id="alamat" rows="5" required=""
                                        placeholder="Masukkan alamat lokasi Tanah.."></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="keterangan" id="keterangan" rows="5"
                                        placeholder="Masukkan keterangan Tanah.."></textarea>
                                </div>
                        </div>
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="edittanah" tabindex="-1" role="dialog"
                aria-labelledby="scrollableModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/edittanah" method="POST"
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Tanah</label>
                                    <input class="form-control" name="jenis_tanah" type="text" id="nameedit2"
                                        placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Luas Tanah</label>
                                    <input class="form-control" name="luas_tanah" type="text" id="nameedit3"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Alamat</label>
                                    <textarea class="form-control" name="alamat" id="nameedit9" rows="5" required=""
                                        placeholder="Masukkan alamat lokasi Tanah.."></textarea>
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">latitude</label>
                                    <input class="form-control" name="lat" type="text" id="nameedit10"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">longitude</label>
                                    <input class="form-control" name="long" type="text" id="nameedit11"
                                        required="" placeholder="">
