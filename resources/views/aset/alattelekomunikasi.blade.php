...
<body class="loading" data-layout="topnav"
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                            ...
                            <div class="page-title-box">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb bg-light-lighten p-2">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Alat Telekomunikasi
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="text-sm-end">
                                                    <a href="../exportasetalattelekomunikasi"> <button type="button"
                                                    ...
                                                    <button type="button" data-bs-toggle="modal"
                                                        data-bs-target="#addalattelekomunikasi"
                                                ...
                                                <div class="tab-pane show active" id="buttons-table-preview">
                                                    ...
                                                    <table id="datatable-buttons"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="table-action">
                                                                    <a data-bs-toggle="modal"
                                                                        data-bs-target="#previewalattelekomunikasi-<?= $user->id_alattelekomunikasi ?>"
                                                                        data-id='<?= $user->id_alattelekomunikasi ?>'
                                                                        class="action-icon"> <i
                                                        ...
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <a onclick="loaddata(<?= $nourut ?>);"
                                                                        ...
                                                                        data-bs-target="#editalattelekomunikasi"
                                                                        class="action-icon"
                                                                        id="editbutton-<?= $nourut ?>"
                                                                        data-petugasdua='<?= $user->id_petugas2 ?>'
                                                                        data-id='<?= $user->id_alattelekomunikasi ?>'
                                                                        data-nama='<?= $user->nama_alattelekomunikasi ?>'
                                                                        data-jenis='<?= $jenis ?>'
                                                                        data-merek='<?= $user->merek_alattelekomunikasi ?>'
                                                                        data-tipe='<?= $user->tipe_alattelekomunikasi ?>'
                                                                        data-imei1='<?= $user->imei1_alattelekomunikasi ?>'
                                                                        data-imei2='<?= $user->imei2_alattelekomunikasi ?>'
                                                                    ...
                                                                    <a onclick="return swallnya(<?= $user->id_alattelekomunikasi ?>)"
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="../qr22/<?= $tanggalbarang->format('Y') ?>/<?= $tanggalbarang->format('m') ?>/<?= $user->kode_alattelekomunikasi ?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?= $no ?>/<?= str_replace('/', ' atau ', $user->nama_alattelekomunikasi) ?>/<?= str_replace('/', ' atau ', $jenis) ?>/<?= str_replace('/', ' atau ', $merek) ?>/<?= str_replace('/', ' atau ', $tipe) ?>/<?= str_replace('/', ' atau ', $ket) ?>"
                                                                        class="action-icon"> <i
                                                                            class="mdi mdi-qrcode"></i></a>
                                                                </td>
                                                                <!-- Preview Modal -->
                                                                <div id="previewalattelekomunikasi-<?= $user->id_alattelekomunikasi ?>"
                                                                                ...
                                                                                <div class="row mt-4">
                                                                                    <div class="col-sm-4">
                                                                                        <p class="text"><strong>Nama
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->nama_alattelekomunikasi ?></span>
                                                                                        </p>
                                                                                        ...
                                                                                        <p class="text"><strong>Merek
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->merek_alattelekomunikasi ?></span>
                                                                                        </p>
                                                                                        <p class="text"><strong>Tipe
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->tipe_alattelekomunikasi ?></span>
                                                                                        </p>
                                                                                        <?php if (!empty($user->imei1_alattelekomunikasi) || !empty($user->imei2_alattelekomunikasi)): ?>
                                                                                        <?php if (!empty($user->imei1_alattelekomunikasi)): ?>
                                                                                        <p class="text"><strong>IMEI1
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->imei1_alattelekomunikasi ?></span>
                                                                                        </p>
                                                                                        <?php endif; ?>

                                                                                        <?php if (!empty($user->imei2_alattelekomunikasi)): ?>
                                                                                        <p class="text"><strong>IMEI2
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->imei2_alattelekomunikasi ?></span>
                                                                                        </p>
                                                                                        <?php endif; ?>
                                                                                        <?php endif; ?>
                                                                                        ...
                                                                                        <p class="text">
                                                                                            <strong>Spesifikasi
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->spesifikasi_alattelekomunikasi ?></span>
                                                                                        </p>

                                                                                        <p class="text"><strong>Kode
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->kode_alattelekomunikasi ?></span>
                                                                                        </p>
                                                                                        <p class="text">
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="addalattelekomunikasi" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/addalattelekomunikasi" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Aset</label>
                                    <input class="form-control" name="nama_alattelekomunikasi" type="text"
                                        id="nama_alattelekomunikasi" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Aset</label>
                                    <input class="form-control" name="jenis_alattelekomunikasi" type="text"
                                        id="jenis_alattelekomunikasi" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Merek</label>
                                    <input class="form-control" name="merek_alattelekomunikasi" type="text"
                                        id="merek_alattelekomunikasi" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Tipe</label>
                                    <input class="form-control" name="tipe_alattelekomunikasi" type="text"
                                        id="tipe_alattelekomunikasi" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 hidden" id="imei1Field">
                                    ...
                                    <input class="form-control" style="text-transform:uppercase;"
                                        name="imei1_alattelekomunikasi" type="number" id="imei1"
                                        placeholder="">
                                </div>
                                ...
                                <div class="mb-3 hidden" id="imei2Field">
                                    ...
                                    <input class="form-control" style="text-transform:uppercase;"
                                        name="imei2_alattelekomunikasi" type="number" id="imei2"
                                        placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Spesifikasi</label>
                                    <textarea class="form-control" name="spesifikasi_alattelekomunikasi" id="spesifikasi_alattelekomunikasi"
                                        required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang Spesifikasi aset.."></textarea>
                                </div>
                                <div class="mb-3">
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="editalattelekomunikasi" tabindex="-1" role="dialog"
                aria-labelledby="scrollableModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/editalattelekomunikasi" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Aset</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" style="text-transform:uppercase;"
                                        name="imei1_alattelekomunikasi" type="number" id="nameedit21"
                                        placeholder="">
                                    <input class="form-control" name="id" type="hidden" id="idedit21"
                                        placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">IME2</label>
                                    <input class="form-control" style="text-transform:uppercase;"
                                        name="imei2_alattelekomunikasi" type="number" id="nameedit22"
                                        placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Spesifikasi</label>
                                    <textarea class="form-control" name="spesifikasi_alattelekomunikasi" id="nameedit5" required="" rows="5"
