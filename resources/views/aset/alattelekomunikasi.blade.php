...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Aset Alat Telekomunikasi | AIS</title>
    ...
    <ol class="breadcrumb bg-light-lighten p-2">
        ...
        <li class="breadcrumb-item active" aria-current="page">Alat Telekomunikasi</li>
    </ol>
</nav>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="row mb-2">
                                            <div class="col-sm-4">
                        @if(count($aset_alattelekomunikasi) > 1)
                            <a target="_blank" href="../qrallalattelekomunikasi/">
                        ...
                        @endif
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="text-sm-end">
                                                    <a href="../exportasetalattelekomunikasi"> <button type="button"   class="btn btn-danger mb-2 me-1"><i class="mdi mdi-file-excel me-2"></i>Excel</button></a>
                                                    <?php
                                                        if (session('data')->role == 'Corporation') {

                                                        }else {
                                                            ?>
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#addalattelekomunikasi"  class="btn btn-success mb-2 me-1"><i class="mdi mdi-plus-circle me-2"></i>Tambah</button>
                                                            <?php
                                                        }
                                                        ?>
                                            ...
                                            <div class="tab-pane show active" id="buttons-table-preview">
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $nourut = 0;
                                                        foreach($aset_alattelekomunikasi as $user) {
                                                            $nourut++;
                                                            $no = $user->no_aset;
                                                            ...
                                                            <td><?= $nourut ?></td>
                                                            <td><?= $no ?></td>
                                                            <td><?= $user->nama_alattelekomunikasi ?></td>
                                                            <td><?= $jenis ?></td>
                                                            <td><?= $user->merek_alattelekomunikasi ?></td>
                                                            <td><?= $user->kode_alattelekomunikasi?></td>
                                                            ...
                                                            <a data-bs-toggle="modal" data-bs-target="#previewalattelekomunikasi-<?=$user->id_alattelekomunikasi?>" data-id='<?= $user->id_alattelekomunikasi?>' class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                            <?php
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            <a onclick="loaddata(<?=$nourut?>);" data-bs-toggle="modal" data-bs-target="#editalattelekomunikasi" class="action-icon" id="editbutton-<?=$nourut?>" data-petugasdua='<?=$user->id_petugas2?>' data-id='<?= $user->id_alattelekomunikasi ?>' data-nama='<?= $user->nama_alattelekomunikasi?>' data-jenis='<?=$jenis?>'
data-merek='<?=$user->merek_alattelekomunikasi?>'
data-tipe='<?=$user->tipe_alattelekomunikasi?>'
data-spesifikasi='<?=$user->spesifikasi_alattelekomunikasi?>'
data-kondisi='<?=$user->kondisi?>'
data-jumlah='<?=$user->jumlah?>'
data-satuan='<?=$user->satuan?>'
data-nilaiperolehan='<?=$user->nilaiperolehan?>'
data-image='<img src="../assets/images/aset/<?= $user->image?> "'
...
data-keterangan='<?= isset($user->keterangan) ? $user->keterangan : '-'; ?>'  
                                                            ...
                                                            <a onclick="return swallnya(<?=$user->id_alattelekomunikasi?>)" href="#" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            <?php
                                                        }
                                                        ?>
                                                        

                                                            <a target="_blank" href="../qr22/<?=$tanggalbarang->format("Y")?>/<?=$tanggalbarang->format("m")?>/<?= $user->kode_alattelekomunikasi?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?=$no?>/<?= str_replace('/', ' atau ', $user->nama_alattelekomunikasi) ?>/<?= str_replace('/', ' atau ', $jenis) ?>/<?= str_replace('/', ' atau ', $merek) ?>/<?= str_replace('/', ' atau ', $tipe) ?>/<?= str_replace('/', ' atau ', $ket) ?>" class="action-icon"> <i class="mdi mdi-qrcode"></i></a>
                                                            </td>
                                                            <!-- Preview Modal -->
                <div id="previewalattelekomunikasi-<?=$user->id_alattelekomunikasi?>" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                 <!-- end row -->
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-sm-4">
                                                <p class="text"><strong>Nama Aset :</strong> <span class="ms-1"><?= $user->nama_alattelekomunikasi?></span></p>
                                                <p class="text"><strong>Jenis Aset :</strong> <span class="ms-1"><?= $jenis?></span></p>

                                            <p class="text"><strong>Merek :</strong><span class="ms-1"><?= $user->merek_alattelekomunikasi?></span></p>
                                            <p class="text"><strong>Tipe :</strong><span class="ms-1"><?= $user->tipe_alattelekomunikasi?></span></p>
                                            <p class="text"><strong>Spesifikasi :</strong><span class="ms-1"><?= $user->spesifikasi_alattelekomunikasi?></span></p>

                                            <p class="text"><strong>Kode Aset :</strong> <span class="ms-1"><?= $user->kode_alattelekomunikasi?></span></p>
                                            ...
                                            <p class="text"><strong>Foto Aset :</strong><span class="ms-1"><a  target="_blank" href="../assets/images/aset/<?= $user->image?> "><img src="../assets/images/aset/<?= $user->image?> " alt="aset-image" title="aset-img" class="rounded me-2" height="48"></a></span></p>
        ...
        <!-- Scrollable modal -->
<div class="modal fade" id="addalattelekomunikasi" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" height="18">Tambah Alat Telekomunikasi</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            <div class="modal-body">
                <form class="ps-3 pe-3" action="/addalattelekomunikasi" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Aset</label>
                        <input class="form-control" name="nama_alattelekomunikasi" type="text" id="nama_alattelekomunikasi" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Jenis Aset</label>
                        <input class="form-control" name="jenis_alattelekomunikasi" type="text" id="jenis_alattelekomunikasi" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Merek</label>
                        <input class="form-control" name="merek_alattelekomunikasi" type="text" id="merek_alattelekomunikasi" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Tipe</label>
                        <input class="form-control" name="tipe_alattelekomunikasi" type="text" id="tipe_alattelekomunikasi" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Spesifikasi</label>
                        <textarea class="form-control" name="spesifikasi_alattelekomunikasi" id="spesifikasi_alattelekomunikasi" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang Spesifikasi aset.."></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <label for="text" class="form-label">Kondisi</label>
                        <textarea class="form-control" name="kondisi" id="kondisi" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang kondisi aset.."></textarea>
                    </div>
                    <div class="mb-3">
...
<div class="mb-3">
                    <label for="text" class="form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="alamat" rows="5" required="" placeholder="Masukkan alamat aset.."></textarea>
                    </div>
<div class="mb-3">
...
<div class="mb-3">
                    <label for="text" class="form-label">Keterangan</label>
                        <textarea class="form-control" name="keterangan" id="keterangan" rows="5" placeholder="Masukkan keterangan aset.."></textarea>
                    </div>
            </div>
...
<!-- Scrollable modal -->
<div class="modal fade" id="editalattelekomunikasi" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" height="18">Edit Alat Telekomunikasi</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            <div class="modal-body">
                <form class="ps-3 pe-3" action="/editalattelekomunikasi" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Aset</label>
                        <input class="form-control" name="nama_alattelekomunikasi" type="text" id="nameedit" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Jenis Aset</label>
                        <input class="form-control" name="jenis_alattelekomunikasi" type="text" id="nameedit2" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit2" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Merek</label>
                        <input class="form-control" name="merek_alattelekomunikasi" type="text" id="nameedit3" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit3" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Tipe</label>
                        <input class="form-control" name="tipe_alattelekomunikasi" type="text" id="nameedit4" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit4" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Spesifikasi</label>
                        <textarea class="form-control" name="spesifikasi_alattelekomunikasi" id="nameedit5" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang Spesifikasi aset.."></textarea>
                    ...
                    <div class="mb-3">
                    <label for="text" class="form-label">Kondisi</label>
                        <textarea class="form-control" name="kondisi" id="nameedit6" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang kondisi aset.."></textarea>
                    ...
                    <label for="text" class="form-label">Tanggal Barang</label>
                        <input class="form-control" name="tanggal_aset" type="date" id="nameedit10" required="" placeholder="">
...
<div class="mb-3">
                    <label for="text" class="form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="nameedit11" rows="5" required="" placeholder="Masukkan alamat aset.."></textarea>
...
<div class="mb-3">
                        ...
                        <select name="" class="form-select" id="pengguna_barang"  aria-label="Default select example" disabled>
...
<div class="mb-3">
                    <label for="text" class="form-label">Keterangan</label>
                        <textarea class="form-control" name="keterangan" id="nameedit12" rows="5" placeholder="Masukkan keterangan aset.."></textarea>
...
<script src="assets/js/ui/component.fileupload.js"></script>
    ...
    swal({
      ...
      if (isConfirm) {
        window.location.href = '/deletealattelekomunikasi/'+id;
      } else {
      }
    })
