...
<body class="loading" data-layout="topnav"
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="text-sm-end">
                                                    <a href="../exportasetalatac"> <button type="button"
                                                    ...
                                                    <table id="datatable-buttons"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="table-action">
                                                                    <a data-bs-toggle="modal"
                                                                        data-bs-target="#previewalatac-<?= $user->id_alatac ?>"
                                                                        data-id='<?= $user->id_alatac ?>'
                                                                        class="action-icon"> <i
                                                        ...
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <a onclick="return swallnya(<?= $user->id_alatac ?>)"
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="../qr22/<?= $tanggalbarang->format('Y') ?>/<?= $tanggalbarang->format('m') ?>/<?= $user->kode_alatac ?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?= $no ?>/<?= str_replace('/', ' atau ', $user->nama_alatac) ?>/<?= str_replace('/', ' atau ', $jenis) ?>/<?= str_replace('/', ' atau ', $merek) ?>/<?= str_replace('/', ' atau ', $tipe) ?>/<?= str_replace('/', ' atau ', $ket) ?>"
                                                                        class="action-icon"> <i
                                                                            class="mdi mdi-qrcode"></i></a>
                                                                </td>
                                                                <!-- Preview Modal -->
                                                                <div id="previewalatac-<?= $user->id_alatac ?>"
                                                                                ...
                                                                                <div class="row mt-4">
                                                                                    <div class="col-sm-4">
                                                                                        <p class="text"><strong>Nama
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->nama_alatac ?></span>
                                                                                        </p>
                                                                                        ...
                                                                                        <p class="text"><strong>Merek
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->merek_alatac ?></span>
                                                                                        </p>
                                                                                        <p class="text"><strong>Tipe
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->tipe_alatac ?></span>
                                                                                        </p>
                                                                                        <p class="text">
                                                                                            <strong>Spesifikasi
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->spesifikasi_alatac ?></span>
                                                                                        </p>

                                                                                        <p class="text"><strong>Kode
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->kode_alatac ?></span>
                                                                                        </p>
                                                                                        <p class="text">
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="addalatac" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/addalatac" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Aset</label>
                                    <input class="form-control" name="nama_alatac" type="text" id="nama_alatac"
                                        required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Aset</label>
                                    <input class="form-control" name="jenis_alatac" type="text" id="jenis_alatac"
                                        required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Merek</label>
                                    <input class="form-control" name="merek_alatac" type="text" id="merek_alatac"
                                        required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Tipe</label>
                                    <input class="form-control" name="tipe_alatac" type="text" id="tipe_alatac"
                                        required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Spesifikasi</label>
                                    <textarea class="form-control" name="spesifikasi_alatac" id="spesifikasi_alatac" required="" rows="5"
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="editalatac" tabindex="-1" role="dialog"
                aria-labelledby="scrollableModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/editalatac" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Aset</label>
                                    <input class="form-control" name="nama_alatac" type="text" id="nameedit"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Aset</label>
                                    <input class="form-control" name="jenis_alatac" type="text" id="nameedit2"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Merek</label>
                                    <input class="form-control" name="merek_alatac" type="text" id="nameedit3"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Tipe</label>
                                    <input class="form-control" name="tipe_alatac" type="text" id="nameedit4"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Spesifikasi</label>
                                    <textarea class="form-control" name="spesifikasi_alatac" id="nameedit5" required="" rows="5"
                                        placeholder="Masukkan beberapa ringkasan tentang Spesifikasi aset.."></textarea>
