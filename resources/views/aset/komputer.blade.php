...
<body class="loading" data-layout="topnav"
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="text-sm-end">
                                                    <a href="../exportasetkomputer"> <button type="button"
                                                ...
                                                <div class="tab-pane show active" id="buttons-table-preview">
                                                    ...
                                                    <table id="datatable-buttons"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="table-action">
                                                                    <a data-bs-toggle="modal"
                                                                        data-bs-target="#previewkomputer-<?= $user->id_komputer ?>"
                                                                        data-id='<?= $user->id_komputer ?>'
                                                                        class="action-icon"> <i
                                                        ...
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <a onclick="loaddata(<?= $nourut ?>);"
                                                                        ...
                                                                        data-bs-target="#editkomputer"
                                                                        class="action-icon"
                                                                        id="editbutton-<?= $nourut ?>"
                                                                        data-petugasdua='<?= $user->id_petugas2 ?>'
                                                                        data-id='<?= $user->id_komputer ?>'
                                                                        data-nama='<?= $user->nama_komputer ?>'
                                                                        data-jenis='<?= $jenis ?>'
                                                                    ...
                                                                    <a onclick="return swallnya(<?= $user->id_komputer ?>)"
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="../qr22/<?= $tanggalbarang->format('Y') ?>/<?= $tanggalbarang->format('m') ?>/<?= $user->kode_komputer ?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?= $no ?>/<?= str_replace('/', ' atau ', $user->nama_komputer) ?>/<?= str_replace('/', ' atau ', $jenis) ?>/<?= str_replace('/', ' atau ', $merek) ?>/<?= str_replace('/', ' atau ', $tipe) ?>/<?= str_replace('/', ' atau ', $ket) ?>"
                                                                        class="action-icon"> <i
                                                                            class="mdi mdi-qrcode"></i></a>
                                                                </td>
                                                                <!-- Preview Modal -->
                                                                <div id="previewkomputer-<?= $user->id_komputer ?>"
                                                                                ...
                                                                                <div class="row mt-4">
                                                                                    <div class="col-sm-4">
                                                                                        <p class="text"><strong>Nama
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->nama_komputer ?></span>
                                                                                        </p>
                                                                                        ...
                                                                                        <p class="text"><strong>Merek
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->merek_komputer ?></span>
                                                                                        </p>
                                                                                        <p class="text"><strong>Tipe
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->tipe_komputer ?></span>
                                                                                        </p>
                                                                                        <p class="text">
                                                                                            <strong>Spesifikasi
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->spesifikasi_komputer ?></span>
                                                                                        </p>

                                                                                        <p class="text"><strong>Kode
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->kode_komputer ?></span>
                                                                                        </p>
                                                                                        <p class="text">
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="addkomputer" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/addkomputer" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Aset</label>
                                    <input class="form-control" name="nama_komputer" type="text"
                                        id="nama_komputer" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Aset</label>
                                    <input class="form-control" name="jenis_komputer" type="text"
                                        id="jenis_komputer" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Merek</label>
                                    <input class="form-control" name="merek_komputer" type="text"
                                        id="merek_komputer" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Tipe</label>
                                    <input class="form-control" name="tipe_komputer" type="text"
                                        id="tipe_komputer" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Spesifikasi</label>
                                    <textarea class="form-control" name="spesifikasi_komputer" id="spesifikasi_komputer" required="" rows="5"
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="editkomputer" tabindex="-1" role="dialog"
                aria-labelledby="scrollableModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/editkomputer" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Aset</label>
                                    <input class="form-control" name="nama_komputer" type="text" id="nameedit"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Aset</label>
                                    <input class="form-control" name="jenis_komputer" type="text" id="nameedit2"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Merek</label>
                                    <input class="form-control" name="merek_komputer" type="text" id="nameedit3"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Tipe</label>
                                    <input class="form-control" name="tipe_komputer" type="text" id="nameedit4"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Spesifikasi</label>
                                    <textarea class="form-control" name="spesifikasi_komputer" id="nameedit5" required="" rows="5"
                                        placeholder="Masukkan beberapa ringkasan tentang Spesifikasi aset.."></textarea>
