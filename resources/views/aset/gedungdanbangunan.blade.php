...
<body class="loading" data-layout="topnav"
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                            ...
                            <div class="page-title-box">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb bg-light-lighten p-2">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Gedung dan Bangunan
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="text-sm-end">
                                                    <a href="../exportasetgedungdanbangunan"> <button type="button"
                                                    ...
                                                    <button type="button" data-bs-toggle="modal"
                                                        data-bs-target="#addgedungdanbangunan"
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane show active" id="buttons-table-preview">
                                                    ...
                                                    <table id="datatable-buttons"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="table-action">
                                                                    <a data-bs-toggle="modal"
                                                                        data-bs-target="#previewgedungdanbangunan-<?= $user->id_gedungdanbangunan ?>"
                                                                        data-id='<?= $user->id_gedungdanbangunan ?>'
                                                                        class="action-icon"> <i
                                                        ...
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <a onclick="loaddata(<?= $nourut ?>);"
                                                                        ...
                                                                        data-bs-target="#editgedungdanbangunan"
                                                                        class="action-icon"
                                                                        id="editbutton-<?= $nourut ?>"
                                                                        data-petugasdua='<?= $user->id_petugas2 ?>'
                                                                        data-id='<?= $user->id_gedungdanbangunan ?>'
                                                                        data-nama='<?= $user->nama_gedungdanbangunan ?>'
                                                                        data-jenis='<?= $jenis ?>'
                                                                        data-objek='<?= $objek ?>'
                                                                        data-luas='<?= $luas ?>'
                                                                    ...
                                                                    <a onclick="return swallnya(<?= $user->id_gedungdanbangunan ?>)"
                                                        ...
                                                        ?>
                                                                    <a target="_blank"
                                                                        href="../qrgedungdanbangunan/<?= $tanggalbarang->format('Y') ?>/<?= $tanggalbarang->format('m') ?>/<?= $user->kode_aset_gedungdanbangunan ?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?= $no ?>/<?= $user->nama_gedungdanbangunan ?>/<?= str_replace('/', ' atau ', $objek) ?>/<?= str_replace('/', ' atau ', $jenis) ?>/<?= str_replace('/', ' atau ', $luas) ?>/<?= str_replace('/', ' atau ', $latitude) ?>/<?= str_replace('/', ' atau ', $longitude) ?>/<?= str_replace('/', ' atau ', $ket) ?>"
                                                                        class="action-icon"> <i
                                                                            class="mdi mdi-qrcode"></i></a>
                                                                </td>
                                                                </td>
                                                                <!-- Preview Modal -->
                                                                <div id="previewgedungdanbangunan-<?= $user->id_gedungdanbangunan ?>"
                                                                                ...
                                                                                <div class="row mt-4">
                                                                                    <div class="col-sm-4">
                                                                                        <p class="text"><strong>Nama
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->nama_gedungdanbangunan ?></span>
                                                                                        </p>
                                                                                        <p class="text"><strong>Nama
                                                                                                Objek :</strong> <span
                                                                                                class="ms-1"><?= $objek ?></span>
                                                                                        </p>
                                                                                        <p class="text">
                                                                                            <strong>Konstruksi
                                                                                                Gedung/Bangunan
                                                                                        ...
                                                                                        <p class="text"><strong>Kode
                                                                                                Aset :</strong> <span
                                                                                                class="ms-1"><?= $user->kode_aset_gedungdanbangunan ?></span>
                                                                                        </p>
                                                                                        <p class="text"><strong>Luas
                                                                                                Gedung/Bangunan
                                                                                                :</strong> <span
                                                                                                class="ms-1"><?= $luas ?></span>
                                                                                        </p>
                                                                                        <p class="text">
                                                                                        ...
                                                                                        <p class="text">
                                                                                            ...
                                                                                            <span
                                                                                                class="ms-1"><?= $latitude ?></span>
                                                                                        </p>
                                                                                        <p class="text">
                                                                                            <strong>longitude :</strong>
                                                                                            <span
                                                                                                class="ms-1"><?= $longitude ?></span>
                                                                                        </p>
                                                                                        ...
                                                                                        <p class="text">
                                                                                            <strong>Sertifikat
                                                                                                ...
                                                                                                :</strong><span
                                                                                                class="ms-1">
                                                                                                <?= $user->sertifikat_kepemilikan ?></span>
                                                                                        </p>
                                                                                        <p class="text">
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="addgedungdanbangunan" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/addgedungdanbangunan" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Aset</label>
                                    <input class="form-control" name="nama_gedungdanbangunan" type="text"
                                        id="nama_gedungdanbangunan" value="Aset Tetap Gedung dan Bangunan" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Objek</label>
                                    <input class="form-control" name="nama_objek" type="text"
                                        style="text-transform:uppercase;" id="nama_objek" required=""
                                        placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Konstruksi Gedung/Bangunan</label>
                                    <input class="form-control" name="jenis_gedungdanbangunan" type="text"
                                        id="jenis_gedungdanbangunan" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Luas Gedung/Bangunan</label>
                                    <input class="form-control" name="luas_gedungdanbangunan" type="text"
                                        id="	luas_gedungdanbangunan" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="kondisi" id="kondisi" required="" rows="5"
                                        placeholder="Masukkan beberapa ringkasan tentang kondisi Gedung/Bangunan.."></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="sertifikat_kepemilikan" type="text"
                                        id="sertifikat_kepemilikan" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="alamat" id="alamat" rows="5" required=""
                                        placeholder="Masukkan alamat lokasi Gedung/Bangunan.."></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="long" type="text" id="long"
                                        required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="keterangan" id="keterangan" rows="5"
                                        placeholder="Masukkan keterangan Gedung/Bangunan.."></textarea>
                                </div>
                        </div>
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="editgedungdanbangunan" tabindex="-1" role="dialog"
                aria-labelledby="scrollableModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/editgedungdanbangunan" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Aset</label>
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Objek</label>
                                    <input class="form-control" name="nama_objek" style="text-transform:uppercase;"
                                        type="text" id="nameedit" required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Kondisi</label>
                                    <textarea class="form-control" name="kondisi" id="nameedit4" required="" rows="5"
                                        placeholder="Masukkan beberapa ringkasan tentang kondisi Gedung/Bangunan.."></textarea>
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nilai Perolehan Aset</label>
                                    <input class="form-control" name="nilaiperolehan" type="number" id="nameedit5"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Tanggal Aset</label>
                                    <input class="form-control" name="tanggal_aset" type="date" id="nameedit7"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Alamat</label>
                                    <textarea class="form-control" name="alamat" id="nameedit8" rows="5" required=""
                                        placeholder="Masukkan alamat lokasi Gedung/Bangunan.."></textarea>
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">latitude</label>
                                    <input class="form-control" name="lat" type="text" id="nameedit9"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">longitude</label>
                                    <input class="form-control" name="long" type="text" id="nameedit10"
                                        required="" placeholder="">
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Keterangan</label>
                                    <textarea class="form-control" name="keterangan" id="nameedit11" rows="5"
                                        placeholder="Masukkan keterangan Gedung/bangunan.."></textarea>
