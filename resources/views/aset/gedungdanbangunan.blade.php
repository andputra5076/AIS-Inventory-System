                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="row mb-2">
                                            <div class="col-sm-4">
                        @if(count($aset_gedungdanbangunan) > 1)
                            <a target="_blank" href="../qrallgedungdanbangunan/">
                        ...
                        @endif
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="text-sm-end">
                                                    <a href="../exportasetgedungdanbangunan"> <button type="button"   class="btn btn-danger mb-2 me-1"><i class="mdi mdi-file-excel me-2"></i>Excel</button></a>
                                                    <?php
                                                        if (session('data')->role == 'Corporation') {

                                                        }else {
                                                            ?>
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#addgedungdanbangunan"  class="btn btn-success mb-2 me-1"><i class="mdi mdi-plus-circle me-2"></i>Tambah</button>
                                                            <?php
                                                        }
                                                        ?>
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Nama Objek</th>
                                                            <th>Kode Aset</th>
                                                            <th>Konstruksi Gedung/Bangunan</th>
                                                            <th>Tahun</th>
                                                            <th>Bulan</th>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $nourut = 0;
                                                        foreach($aset_gedungdanbangunan as $user) {
                                                            $nourut ++;
                                                            $no = $user->no_aset;
                                                            ...
                                                            <td><?= $nourut?></td>
                                                            <td><?= $no ?></td>
                                                            <td><?= $user->nama_gedungdanbangunan?></td>
                                                            <td><?= $objek ?></td>
                                                            <td><?= $user->kode_aset_gedungdanbangunan?></td>
                                                            <td><?= $jenis?></td>
                                                            ...
                                                            <a data-bs-toggle="modal" data-bs-target="#previewgedungdanbangunan-<?=$user->id_gedungdanbangunan?>" data-id='<?= $user->id_gedungdanbangunan?>' class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                            <?php
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            <a onclick="loaddata(<?=$nourut?>);" data-bs-toggle="modal" data-bs-target="#editgedungdanbangunan" class="action-icon" id="editbutton-<?=$nourut?>" data-petugasdua='<?=$user->id_petugas2?>' data-id='<?= $user->id_gedungdanbangunan ?>' data-nama='<?= $user->nama_gedungdanbangunan?>' data-jenis='<?= $jenis?>'
data-objek='<?= $objek?>'
data-luas='<?= $luas?>'
data-kondisi='<?=   $user->kondisi?>'
data-satuan='<?=   $user->satuan?>'
data-sertifikat='<?= $user->sertifikat_kepemilikan?>'
data-lat='<?=   $latitude?>'
data-long='<?=   $longitude?>'
...
data-keterangan='<?= isset($user->keterangan) ? $user->keterangan : '-'; ?>'  
                                                            ...
                                                            <a onclick="return swallnya(<?=$user->id_gedungdanbangunan?>)" href="#" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            <?php
                                                        }
                                                        ?>    
                                                            <a target="_blank" href="../qrgedungdanbangunan/<?=$tanggalbarang->format("Y")?>/<?=$tanggalbarang->format("m")?>/<?= $user->kode_aset_gedungdanbangunan ?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?=$no?>/<?=$user->nama_gedungdanbangunan?>/<?=str_replace('/', ' atau ', $objek)?>/<?=str_replace('/', ' atau ', $jenis)?>/<?= str_replace ('/', ' atau ', $luas) ?>/<?= str_replace('/', ' atau ', $latitude) ?>/<?=str_replace('/', ' atau ',  $longitude) ?>/<?= str_replace('/', ' atau ', $ket)?>" class="action-icon"> <i class="mdi mdi-qrcode"></i></a></td>
                                                            </td>
                                                            <!-- Preview Modal -->
                <div id="previewgedungdanbangunan-<?=$user->id_gedungdanbangunan?>" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                 <!-- end row -->
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-sm-4">
                                                <p class="text"><strong>Nama Aset :</strong> <span class="ms-1"><?= $user->nama_gedungdanbangunan?></span></p>
                                                <p class="text"><strong>Nama Objek :</strong> <span class="ms-1"><?= $objek?></span></p>
                                                <p class="text"><strong>Konstruksi Gedung/Bangunan :</strong> <span class="ms-1"><?= $jenis?></span></p>
                                            <p class="text"><strong>Kode Aset :</strong> <span class="ms-1"><?= $user->kode_aset_gedungdanbangunan?></span></p>
                                            <p class="text"><strong>Luas Gedung/Bangunan :</strong> <span class="ms-1"><?= $luas?></span></p>
                                            <p class="text"><strong>Kondisi :</strong> <span class="ms-1"><?= $user->kondisi?></span></p>
                                            <p class="text"><strong>latitude :</strong> <span class="ms-1"><?= $latitude?></span></p>
                                            <p class="text"><strong>longitude :</strong> <span class="ms-1"><?= $longitude?></span></p>

                                            <p class="text"><strong>Sertifikat Kepemilikan :</strong><span class="ms-1"> <?= $user->sertifikat_kepemilikan?></span></p>
                                            ...
                                            <p class="text"><strong>Foto Gedung/Bangunan :</strong><span class="ms-1"><a  target="_blank" href="../assets/images/aset/<?= $user->image?> "><img src="../assets/images/aset/<?= $user->image?> " alt="aset-image" title="aset-img" class="rounded me-2" height="48"></a></span></p>
        ...
        <!-- Scrollable modal -->
<div class="modal fade" id="addgedungdanbangunan" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" height="18">Tambah Gedung dan Bangunan</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            <div class="modal-body">
                <form class="ps-3 pe-3" action="/addgedungdanbangunan" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Aset</label>
                        <input class="form-control" name="nama_gedungdanbangunan" type="text" id="nama_gedungdanbangunan" value="Aset Tetap Gedung dan Bangunan" readonly>
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Objek</label>
                        <input class="form-control" name="nama_objek" type="text" style="text-transform:uppercase;" id="nama_objek" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Konstruksi Gedung/Bangunan</label>
                        <input class="form-control" name="jenis_gedungdanbangunan" type="text" id="jenis_gedungdanbangunan" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Luas Gedung/Bangunan</label>
                        <input class="form-control" name="luas_gedungdanbangunan" type="text" id="	luas_gedungdanbangunan" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    ...
                    <label for="text" class="form-label">Kondisi</label>
                        <textarea class="form-control" name="kondisi" id="kondisi" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang kondisi Gedung/Bangunan.."></textarea>
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Satuan</label>
                        <input class="form-control" name="satuan" type="text" id="satuan" value="m²" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <label for="text" class="form-label">Sertifikat Kepemilikan</label>
                        <input class="form-control" name="sertifikat_kepemilikan" type="text" id="sertifikat_kepemilikan" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="fallback">
                                                                <label for="image" class="form-label">Foto Gedung/Bangunan</label>
...
<div class="mb-3">
                    <label for="text" class="form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="alamat" rows="5" required="" placeholder="Masukkan alamat lokasi Gedung/Bangunan.."></textarea>
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">latitude</label>
                        <input class="form-control" name="lat" type="text" id="lat" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">longitude</label>
                        <input class="form-control" name="long" type="text" id="long" required="" placeholder="">
                    </div>
<div class="mb-3">
...
<div class="mb-3">
                    <label for="text" class="form-label">Keterangan</label>
                        <textarea class="form-control" name="keterangan" id="keterangan" rows="5" placeholder="Masukkan keterangan Gedung/Bangunan.."></textarea>
                    </div>
            </div>
...
<!-- Scrollable modal -->
<div class="modal fade" id="editgedungdanbangunan" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" height="18">Edit Gedung dan Bangunan</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            <div class="modal-body">
                <form class="ps-3 pe-3" action="/editgedungdanbangunan" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Aset</label>
                        <input class="form-control" name="nama_gedungdanbangunan" type="text" id="nama_gedungdanbangunan" value="Aset Tetap Gedung dan Bangunan" readonly>
                    ...
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Objek</label>
                        <input class="form-control" name="nama_objek" style="text-transform:uppercase;" type="text" id="nameedit" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Konstruksi Gedung/Bangunan</label>
                        <input class="form-control" name="jenis_gedungdanbangunan" type="text" id="nameedit2" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit2" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Luas Gedung/Bangunan</label>
                        <input class="form-control" name="luas_gedungdanbangunan" type="text" id="nameedit3" required="" placeholder="">
                    ...
                    <div class="mb-3">
                    <label for="text" class="form-label">Kondisi</label>
                        <textarea class="form-control" name="kondisi" id="nameedit4" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang kondisi Gedung/Bangunan.."></textarea>
                    ...
                    <div class="mb-3">
                    <label for="text" class="form-label">Nilai Perolehan Aset</label>
                        <input class="form-control" name="nilaiperolehan" type="number" id="nameedit5" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit5" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Sertifikat Kepemilikan</label>
                        <input class="form-control" name="sertifikat_kepemilikan" type="text" id="nameedit6" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit6" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Tanggal Aset</label>
                        <input class="form-control" name="tanggal_aset" type="date" id="nameedit7" required="" placeholder="">
...
<div class="mb-3">
                    <label for="text" class="form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="nameedit8" rows="5" required="" placeholder="Masukkan alamat lokasi Gedung/Bangunan.."></textarea>
                        <input class="form-control" name="id" type="hidden" id="idedit8" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">latitude</label>
                        <input class="form-control" name="lat" type="text" id="nameedit9" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit9" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">longitude</label>
                        <input class="form-control" name="long" type="text" id="nameedit10" required="" placeholder="">
...
<div class="mb-3">
                    <label for="text" class="form-label">Keterangan</label>
                        <textarea class="form-control" name="keterangan" id="nameedit11" rows="5" placeholder="Masukkan keterangan Gedung/bangunan.."></textarea>
...
<script src="assets/js/ui/component.fileupload.js"></script>
    ...
    swal({
      ...
      if (isConfirm) {
        window.location.href = '/deletegedungdanbangunan/'+id;
      } else {
      }
    })
    ...
    $('#nameedit').val($('#editbutton-'+urut).data('objek'));
    $('#nameedit2').val($('#editbutton-'+urut).data('jenis'));
    $('#nameedit3').val($('#editbutton-'+urut).data('luas'));
    $('#nameedit4').val($('#editbutton-'+urut).data('kondisi'));
    $('#nameedit5').val($('#editbutton-'+urut).data('nilaiperolehan'));
    $('#nameedit6').val($('#editbutton-'+urut).data('sertifikat'));
    $('#nameedit9').val($('#editbutton-'+urut).data('lat'));
    $('#nameedit10').val($('#editbutton-'+urut).data('long'));
    
    const formattedDate = convertDate($('#editbutton-'+urut).data('tanggal'));
    if (formattedDate) {
       $('#nameedit7').val(formattedDate);
    }

   
    $('#nameedit8').val($('#editbutton-'+urut).data('alamat'));
    $('#nameedit11').val($('#editbutton-'+urut).data('keterangan'));
    ...
    console.log($('#editbutton-'+urut).data('objek'));
