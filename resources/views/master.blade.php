                                                ...
                                                <div class="text-sm-end">
                                                    <?php
                                                        if (session('data')->role != 'Corporation') {
                                                            ...
                                                            ?>
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#addunitusaha" class="btn btn-success mb-2 me-1"><i class="mdi mdi-plus-circle me-2"></i>Tambah</button>
                                                            <?php
                                                        }
                                                        ?>
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach($users as $user) {
                                                            ...
                                                            <a type="button" data-bs-toggle="modal" data-bs-target="#editunitusaha" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
