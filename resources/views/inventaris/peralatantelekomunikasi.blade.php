...
<body class="loading" data-layout="topnav"
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                            ...
                            <div class="page-title-box">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb bg-light-lighten p-2">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Peralatan
                                            Telekomunikasi</li>
                                    </ol>
                                </nav>
                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="text-sm-end">
                                                    ...
                                                    <a href="../exportinventarisperalatantelekomunikasi"> <button
                                                    ...
                                                    <button type="button" data-bs-toggle="modal"
                                                        data-bs-target="#addperalatantelekomunikasi"
                                                ...
                                                <div class="tab-pane show active" id="buttons-table-preview">
                                                    ...
                                                    <table id="datatable-buttons"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="table-action">
                                                                    <a data-bs-toggle="modal"
                                                                        data-bs-target="#previewperalatantelekomunikasi-<?= $user->id_peralatantelekomunikasi ?>"
                                                                        data-id='<?= $user->id_peralatantelekomunikasi ?>'
                                                                        class="action-icon"> <i
                                                        ...
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <a onclick="loaddata(<?= $nourut ?>);"
                                                                        ...
                                                                        data-bs-target="#editperalatantelekomunikasi"
                                                                        class="action-icon"
                                                                        id="editbutton-<?= $nourut ?>"
                                                                        data-petugasdua='<?= $user->id_petugas2 ?>'
                                                                        data-nama='<?= $user->nama_peralatantelekomunikasi ?>'
                                                                        data-jenis='<?= $jenis ?>'
                                                                    ...
                                                                    <a onclick="return swallnya(<?= $user->id_peralatantelekomunikasi ?>)"
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="../qr2/<?= $tanggalbarang->format('Y') ?>/<?= $tanggalbarang->format('m') ?>/<?= $user->kode_peralatantelekomunikasi ?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?= $no ?>/<?= str_replace('/', ' atau ', $user->nama_peralatantelekomunikasi) ?>/<?= str_replace('/', ' atau ', $jenis) ?>/<?= str_replace('/', ' atau ', $merek) ?>/<?= str_replace('/', ' atau ', $tipe) ?>/<?= str_replace('/', ' atau ', $ket) ?>"
                                                                        class="action-icon"> <i
                                                                            class="mdi mdi-qrcode"></i></a>
                                                                </td>
                                                                <!-- Preview Modal -->
                                                                <div id="previewperalatantelekomunikasi-<?= $user->id_peralatantelekomunikasi ?>"
                                                                                ...
                                                                                <div class="row mt-4">
                                                                                    <div class="col-sm-4">
                                                                                        <p class="text"><strong>Nama
                                                                                                Barang :</strong> <span
                                                                                                class="ms-1"><?= $user->nama_peralatantelekomunikasi ?></span>
                                                                                        </p>
                                                                                        ...
                                                                                        <p class="text"><strong>Merek
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->merek_peralatantelekomunikasi ?></span>
                                                                                        </p>
                                                                                        ...
                                                                                        <p class="text">
                                                                                            <strong>Spesifikasi
                                                                                                :</strong><span
                                                                                                class="ms-1"><?= $user->spesifikasi_peralatantelekomunikasi ?></span>
                                                                                        </p>

                                                                                        <p class="text"><strong>Kode
                                                                                                Barang :</strong> <span
                                                                                                class="ms-1"><?= $user->kode_peralatantelekomunikasi ?></span>
                                                                                        </p>
                                                                                        <p class="text">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        ...
                                                                                        <p class="text"><strong>Foto
                                                                                                ...
                                                                                                class="ms-1"><a
                                                                                                    target="_blank"
                                                                                                    href="../assets/images/inventaris/<?= $user->image ?> "><img
                                                                                                        src="../assets/images/inventaris/<?= $user->image ?> "
                                                                                                        alt="inventaris-image"
                                                                                                        title="inventaris-img"
                                                                                                        class="rounded me-2"
                                                                                                        height="48"></a></span>
                                                                                        </p>
                                                                                        <p class="text">
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="addperalatantelekomunikasi" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/addperalatantelekomunikasi" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Barang</label>
                                    <input class="form-control" name="nama_peralatantelekomunikasi" type="text"
                                        id="nama_peralatantelekomunikasi" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Jenis Barang</label>
                                    <input class="form-control" name="jenis_peralatantelekomunikasi" type="text"
                                        id="jenis_peralatantelekomunikasi" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="text" class="form-label">Merek</label>
                                    <input class="form-control" name="merek_peralatantelekomunikasi" type="text"
                                        id="merek_peralatantelekomunikasi" required="" placeholder="">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="spesifikasi_peralatantelekomunikasi" id="spesifikasi_peralatantelekomunikasi"
                                        required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang Spesifikasi barang.."></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="kondisi" id="kondisi" required="" rows="5"
                                        placeholder="Masukkan beberapa ringkasan tentang kondisi barang.."></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="tanggal_barang" type="date"
                                        id="tanggal_barang" required="" placeholder="">
                                </div>
                                <div class="fallback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="alamat" id="alamat" rows="5" required=""
                                        placeholder="Masukkan alamat barang.."></textarea>
                                </div>
                                <div class="mb-3">
            ...
            <!-- Scrollable modal -->
            <div class="modal fade" id="editperalatantelekomunikasi" tabindex="-1" role="dialog"
                aria-labelledby="scrollableModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="ps-3 pe-3" action="/editperalatantelekomunikasi" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="text" class="form-label">Nama Barang</label>
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Spesifikasi</label>
                                    <textarea class="form-control" name="spesifikasi_peralatantelekomunikasi" id="nameedit5" required=""
                                        rows="5" placeholder="Masukkan beberapa ringkasan tentang Spesifikasi barang.."></textarea>
                                ...
                                <div class="mb-3">
                                    <label for="text" class="form-label">Tanggal Barang</label>
                                    <input class="form-control" name="tanggal_barang" type="date" id="nameedit10"
                                        required="" placeholder="">
