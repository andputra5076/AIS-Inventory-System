...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Inventaris Peralatan Telekomunikasi | AIS</title>
    ...
    <ol class="breadcrumb bg-light-lighten p-2">
        ...
        <li class="breadcrumb-item active" aria-current="page">Peralatan Telekomunikasi</li>
    </ol>
</nav>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="row mb-2">
                                            <div class="col-sm-4">
                        @if(count($inventaris_peralatantelekomunikasi) > 1)
                            <a target="_blank" href="../qrall2/">
                        ...
                        @endif
                                            ...
                                            <div class="col-sm-8">
                                                <div class="text-sm-end">
                                                    ...
                                                    <a href="../exportinventarisperalatantelekomunikasi"> <button type="button"class="btn btn-danger mb-2 me-1"><i class="mdi mdi-file-excel me-2"></i>Excel</button></a>
                                                    <?php
                                                        if (session('data')->role == 'Corporation') {

                                                        }else {
                                                            ?>
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#addperalatantelekomunikasi"  class="btn btn-success mb-2 me-1"><i class="mdi mdi-plus-circle me-2"></i>Tambah</button>
                                                            <?php
                                                        }
                                                        ?>
                                            ...
                                            <div class="tab-pane show active" id="buttons-table-preview">
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $nourut = 0;
                                                        foreach($inventaris_peralatantelekomunikasi as $user) {
                                                            $nourut++;
                                                            ...
                                                            <td><?= $nourut ?></td>
                                                            <td><?= $no ?></td>
                                                            <td><?= $user->nama_peralatantelekomunikasi ?></td>
                                                            <td><?= $jenis ?></td>
                                                            <td><?= $user->merek_peralatantelekomunikasi ?></td>
                                                            <td><?= $user->kode_peralatantelekomunikasi?></td>
                                                            ...
                                                            <a data-bs-toggle="modal" data-bs-target="#previewperalatantelekomunikasi-<?=$user->id_peralatantelekomunikasi?>" data-id='<?= $user->id_peralatantelekomunikasi?>' class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                            <?php
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            <a onclick="loaddata(<?=$nourut?>);" data-bs-toggle="modal" data-bs-target="#editperalatantelekomunikasi" class="action-icon" id="editbutton-<?=$nourut?>" data-petugasdua='<?=$user->id_petugas2?>' data-nama='<?=$user->nama_peralatantelekomunikasi?>'
data-jenis='<?=$jenis?>'
...
data-keterangan='<?= isset($user->keterangan) ? $user->keterangan : '-'; ?>'  data-id='<?= $user->id_peralatantelekomunikasi ?>' data-nama='<?= $user->nama_peralatantelekomunikasi?>'  
                                                            ...
                                                            <a onclick="return swallnya(<?=$user->id_peralatantelekomunikasi?>)" href="#" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            <?php
                                                        }
                                                        ?>
                                                        

                                                            <a target="_blank" href="../qr2/<?=$tanggalbarang->format("Y")?>/<?=$tanggalbarang->format("m")?>/<?= $user->kode_peralatantelekomunikasi?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?=$no?>/<?= str_replace('/', ' atau ', $user->nama_peralatantelekomunikasi) ?>/<?= str_replace('/', ' atau ', $jenis) ?>/<?= str_replace('/', ' atau ', $merek) ?>/<?= str_replace('/', ' atau ', $tipe) ?>/<?= str_replace('/', ' atau ', $ket) ?>" class="action-icon"> <i class="mdi mdi-qrcode"></i></a>
                                                            </td>
                                                            <!-- Preview Modal -->
                <div id="previewperalatantelekomunikasi-<?=$user->id_peralatantelekomunikasi?>" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                 <!-- end row -->
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-sm-4">
                                                <p class="text"><strong>Nama Barang :</strong> <span class="ms-1"><?= $user->nama_peralatantelekomunikasi?></span></p>
                                                <p class="text"><strong>Jenis Barang :</strong> <span class="ms-1"><?= $jenis?></span></p>

                                            <p class="text"><strong>Merek :</strong><span class="ms-1"><?= $user->merek_peralatantelekomunikasi?></span></p>
                                            <p class="text"><strong>Tipe :</strong><span class="ms-1"><?= $user->tipe_peralatantelekomunikasi?></span></p>
                                            <p class="text"><strong>Spesifikasi :</strong><span class="ms-1"><?= $user->spesifikasi_peralatantelekomunikasi?></span></p>

                                            <p class="text"><strong>Kode Barang :</strong> <span class="ms-1"><?= $user->kode_peralatantelekomunikasi?></span></p>
                                            ...
                                            <p class="text"><strong>Foto Barang :</strong><span class="ms-1"><a  target="_blank" href="../assets/images/inventaris/<?= $user->image?> "><img src="../assets/images/inventaris/<?= $user->image?> " alt="inventaris-image" title="inventaris-img" class="rounded me-2" height="48"></a></span></p>
        ...
        <!-- Scrollable modal -->
<div class="modal fade" id="addperalatantelekomunikasi" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" height="18">Tambah Peralatan Telekomunikasi</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            <div class="modal-body">
                <form class="ps-3 pe-3" action="/addperalatantelekomunikasi" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Barang</label>
                        <input class="form-control" name="nama_peralatantelekomunikasi" type="text" id="nama_peralatantelekomunikasi" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Jenis Barang</label>
                        <input class="form-control" name="jenis_peralatantelekomunikasi" type="text" id="jenis_peralatantelekomunikasi" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Merek</label>
                        <input class="form-control" name="merek_peralatantelekomunikasi" type="text" id="merek_peralatantelekomunikasi" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Tipe</label>
                        <input class="form-control" name="tipe_peralatantelekomunikasi" type="text" id="tipe_peralatantelekomunikasi" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Spesifikasi</label>
                        <textarea class="form-control" name="spesifikasi_peralatantelekomunikasi" id="spesifikasi_peralatantelekomunikasi" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang Spesifikasi barang.."></textarea>
                    </div>
                    <div class="mb-3">
...
<!-- Scrollable modal -->
<div class="modal fade" id="editperalatantelekomunikasi" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" height="18">Edit Peralatan Telekomunikasi</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            <div class="modal-body">
                <form class="ps-3 pe-3" action="/editperalatantelekomunikasi" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Barang</label>
                        <input class="form-control" name="nama_peralatantelekomunikasi" type="text" id="nameedit" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Jenis Barang</label>
                        <input class="form-control" name="jenis_peralatantelekomunikasi" type="text" id="nameedit2" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit2" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Merek</label>
                        <input class="form-control" name="merek_peralatantelekomunikasi" type="text" id="nameedit3" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit3" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Tipe</label>
                        <input class="form-control" name="tipe_peralatantelekomunikasi" type="text" id="nameedit4" required="" placeholder="">
                        <input class="form-control" name="id" type="hidden" id="idedit4" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Spesifikasi</label>
                        <textarea class="form-control" name="spesifikasi_peralatantelekomunikasi" id="nameedit5" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang Spesifikasi barang.."></textarea>
...
<div class="mb-3">
     ...
     $('#editbutton').find(".close_btn").click(modal_closing);
});
        </script>
...
<script src="assets/js/ui/component.fileupload.js"></script>
    ...
    swal({
      ...
      if (isConfirm) {
        window.location.href = '/deleteperalatantelekomunikasi/'+id;
      } else {
      }
    })
