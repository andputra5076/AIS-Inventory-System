...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Inventaris Kendaraan | AIS</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-sm-4">
                        @if(count($inventaris_kendaraan) > 1)
                            <a target="_blank" href="../qrall/">
                                                   ...
                                                   <a href="../exportinventariskendaraan"> <button type="button" class="btn btn-danger mb-2 me-1"><i class="mdi mdi-file-excel me-2"></i>Excel</button></a>
                                                    <?php
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            ?>
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#addkendaraan"  class="btn btn-success mb-2 me-1"><i class="mdi mdi-plus-circle me-2"></i>Tambah</button>
                                                            <?php
                                                        }
                                                        ?>
                                                </div>
                                            ...
                                            <div class="tab-pane show active" id="buttons-table-preview">
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $nourut = 0;
                                                        foreach($inventaris_kendaraan as $user) {
                                                            $nourut++;
                                                            ...
                                                            <td><?= $nourut ?></td>
                                                            <td><?= $no ?></td>
                                                            <td><?= $user->nama_barang_kendaraan ?></td>
                                                            <td><?= $jenis ?></td>
                                                            <td><?= $user->merek_kendaraan ?></td>
                                                            <td><?= $user->kode_barang_kendaraan ?></td>
                                                            ...
                                                            <a data-bs-toggle="modal" data-bs-target="#previewkendaraan-<?=$user->id_kendaraan ?>" data-id='<?= $user->id_kendaraan ?>' class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                            <?php
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            <a onclick="loaddata(<?=$nourut?>);" data-bs-toggle="modal" data-bs-target="#editkendaraan" class="action-icon" id="editbutton-<?=$nourut?>" data-petugasdua='<?=$user->id_petugas2?>'  data-id='<?= $user->id_kendaraan  ?>' data-nama='<?= $user->nama_barang_kendaraan?>' data-jenis='<?= $jenis?>'
...
data-image='../assets/images/inventaris/<?= $user->image?> '
...
data-keterangan='<?= isset($user->keterangan) ? $user->keterangan : '-'; ?>' 
                                                            ...
                                                            <a onclick="return swallnya(<?=$user->id_kendaraan ?>)" href="#" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            <?php
                                                        }
                                                        ?>

                                                            <a target="_blank" href="../qr/<?=$tanggalbarang->format("Y")?>/<?=$tanggalbarang->format("m")?>/<?= $user->kode_barang_kendaraan ?>/<?= $user->id_user ?>/<?= $user->usernamanya ?>/<?=$no?>/<?=str_replace('/', ' atau ', $user->nama_barang_kendaraan)?>/<?=str_replace('/', ' atau ', $jenis)?>/<?= str_replace('/', ' atau ', $nopol) ?>/<?=str_replace('/', ' atau ', $merek)?>/<?=str_replace('/', ' atau ', $ket)?>" class="action-icon"> <i class="mdi mdi-qrcode"></i></a>
                                                            </td>
                                                            <!-- Preview Modal -->
                <div id="previewkendaraan-<?=$user->id_kendaraan ?>" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                 <!-- end row -->
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-sm-4">
                                                <p class="text"><strong>Nama Barang/Kendaraan :</strong> <span class="ms-1"><?= $user->nama_barang_kendaraan?></span></p>
                                                <p class="text"><strong>Jenis Kendaraan :</strong> <span class="ms-1"><?= $jenis?></span></p>

                                            <p class="text"><strong>Merek :</strong><span class="ms-1"><?= $user->merek_kendaraan?></span></p>

                                            <p class="text"><strong>Kode Barang :</strong> <span class="ms-1"><?= $user->kode_barang_kendaraan?></span></p>
                                            ...
                                            <p class="text"><strong>Foto Barang/Kendaraan :</strong><span class="ms-1"><a  target="_blank" href="../assets/images/inventaris/<?= $user->image?> "><img src="../assets/images/inventaris/<?= $user->image?> " alt="inventaris-image" title="inventaris-img" class="rounded me-2" height="48"></a></span></p>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="ps-3 pe-3" action="/addkendaraan" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Barang/Kendaraan</label>
                        <input class="form-control" name="nama_barang_kendaraan" type="text" id="nama_barang_kendaraan" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    ...
                    <label for="text" class="form-label">Nomor Polisi</label>
                        <input class="form-control" name="nopol" style="text-transform:uppercase;" type="text" id="nopol" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Nomor Rangka</label>
                        <input class="form-control" name="norangka" style="text-transform:uppercase;" type="text" id="norangka" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Nomor Mesin</label>
                        <input class="form-control" name="nomesin" style="text-transform:uppercase;" type="text" id="nomesin" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    <label for="text" class="form-label">Nomor BPKB</label>
                        <input class="form-control" name="nobpkb" style="text-transform:uppercase;" type="text" id="nobpkb" required="" placeholder="">
                    </div>
                    <div class="mb-3">
                    ...
                    <label for="text" class="form-label">Satuan</label>
                        <input class="form-control" name="satuan" type="text" id="satuan" required="" value="Unit" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="fallback">
                                                                <label for="image" class="form-label">Foto Barang/Kendaraan</label>
...
<!-- Scrollable modal -->
<div class="modal fade" id="editkendaraan" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" height="18">Edit Kendaraan</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            <div class="modal-body">
                <form class="ps-3 pe-3" action="/editkendaraan" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    <label for="text" class="form-label">Nama Barang/Kendaraan</label>
                        <input class="form-control" name="nama_barang_kendaraan" type="text" id="nameedit" required="" placeholder="">
                    ...
                    <div class="mb-3">
                    <label for="text" class="form-label">Kondisi</label>
                        <textarea class="form-control" name="kondisi" id="nameedit9" required="" rows="5" placeholder="Masukkan beberapa ringkasan tentang kondisi barang.."></textarea>
                    ...
                    <div class="mb-3">
                    <label for="text" class="form-label">Tanggal Barang</label>
                        <input class="form-control" name="tanggal_barang" type="date" id="nameedit13" required="" placeholder="">
...
<div class="mb-3">
                    <label for="text" class="form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="nameedit15" rows="5" required="" placeholder="Masukkan alamat barang.."></textarea>
...
<div class="mb-3">
                    ...
                    <div class="mb-3">
                    <label for="text" class="form-label" >Unit Kerja</label>
                        <select name="id_unit_kerja" id="tol"  class="form-select" onchange="updateRuanganeditOptions()" aria-label="Default select example">
                           ...
                           <option id="ruangan" value="">-- Pilih --</option>
                            <?php
                                                        foreach($ruangan as $ruangans) {                                              
                                                            ?>
<option data-unit="<?= $ruangans->id_unit_kerja ?>" data-unit="<?= $ruangans->id_unit_kerja ?>" dataruangan="<?= $ruangans->id_unit_usaha ?>"  value="<?= $ruangans->id ?>"><?= $ruangans->name ?></option>
                        ...
                        <select name="id_petugas1" id="hey" class="form-select" aria-label="Default select example" required="">
                           <option id="petugas">-- Pilih --</option>
                            <?php
                                                        foreach($petugas as $petugasd) {                                              
                                                            ?>
<option data-ruangan="<?= $petugasd->id_ruangan ?>" datapetugas="<?= $petugasd->id_unit_usaha ?>"  value="<?= $petugasd->id ?>"><?= $petugasd->name ?></option>
                    ...
                    <div class="mb-3">
                    <label for="text" class="form-label" >Penanggung Jawab</label>
                        <select name="id_petugas2" id="hoy" class="form-select" aria-label="Default select example"  required="">
                           <option id="petugas2">-- Pilih --</option>
                            <?php
                                                        foreach($petugas as $petugasd) {                                              
                                                            ?>
<option data-ruangan2="<?= $petugasd->id_ruangan ?>" datapetugas2="<?= $petugasd->id_unit_usaha ?>"  value="<?= $petugasd->id ?>,<?= $petugasd->name ?>"><?= $petugasd->name ?></option>
...
<div class="mb-3">
                    <label for="text" class="form-label">Keterangan</label>
                        <textarea class="form-control" name="keterangan" id="nameedit16" rows="5" placeholder="Masukkan keterangan barang.."></textarea>
                        <input class="form-control" name="id" type="hidden" id="idedit16"  placeholder="">
                    </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id="saveBtn">Save</button>
...
<script src="assets/js/ui/component.fileupload.js"></script>
    ...
    swal({
      ...
      if (isConfirm) {
        window.location.href = '/deletekendaraan/'+id;
      } else {
      }
    })
            }
    ...
    console.log($('#editbutton-'+urut).data('nopol'));
    console.log($('#editbutton-'+urut).data('norangka'));
    console.log($('#editbutton-'+urut).data('nomesin'));
    console.log($('#editbutton-'+urut).data('nobpkb'));
    console.log($('#editbutton-'+urut).data('stnk'));
    ...
    console.log($('#editbutton-'+urut).data('image'));
