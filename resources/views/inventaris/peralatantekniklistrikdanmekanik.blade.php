...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Inventaris Peralatan Teknik Listrik dan Mekanik | AIS</title>
    ...
    <ol class="breadcrumb bg-light-lighten p-2">
        ...
        <li class="breadcrumb-item active" aria-current="page">Peralatan Teknik Listrik dan Mekanik</li>
    </ol>
</nav>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-sm-4">
                                                <button type="button" href="#"class="btn btn-light btn-rounded mb-2 me-1"><i class="mdi mdi-crop-free me-2"></i>Print Barcode All</button>
                                            </div>
                                            <div class="col-sm-8">
