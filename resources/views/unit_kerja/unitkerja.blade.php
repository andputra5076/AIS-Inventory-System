...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Dashboard Unit Kerja | AIS</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <a href="" class="topnav-logo">
                                <span class="topnav-logo-lg">
                                    <img src="assets/images/logo-light.png" alt="" width="90"  height="63" >
                                </span>
                            </a>
                            ...
                            <ul class="list-unstyled topbar-menu float-end mb-0">
                                ...
                                <li class="dropdown ">
                                    <a class="nav-link dropdown-toggle nav-user arrow-none me-2" data-bs-toggle="dropdown" id="dropdownMenuLink" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            ...
                            <nav class="navbar navbar-dark navbar-expand-lg topnav-menu">
                                ...
                                <div class="collapse navbar-collapse" id="topnav-menu-content">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="uil-book me-1"></i>Laporan <div class="arrow-down"></div>
                                            </a>
                                            <div class="dropdown-menu" aria-labelledby="topnav-pages">
...
@if(session('success'))
                                                ...
                                                <div class="text-sm-end">
                                                    <?php
                                                        if (session('data')->role == 'Corporation') {
                                                            ...
                                                            ?>
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#addunitkerja" class="btn btn-success mb-2 me-1"><i class="mdi mdi-plus-circle me-2"></i>Tambah</button>
                                                            <?php
                                                        }
                                                        ?>
                                                </div>
                                            ...
                                            <div class="tab-pane show active" id="buttons-table-preview">
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $no = 0;
                                                        foreach($unit_kerja as $user) {
                                                            $no++;
                                                            ?>
                                                            <tr>
                                                            <td><?= $no ?></td>
                                                            <td><span class="badge bg-success"><?=$user->kode?></span></td>
                                                            <td><?= $user->name ?></td>
                                                            <td class="table-action">
                                                            <a data-bs-toggle="modal" data-bs-target="#editunitkerja" class="action-icon" id="editbutton" data-id='<?= $user->id  ?>' data-nama='<?= $user->name ?>' data-kode='<?= $user->kode ?>'> <i class="mdi mdi-square-edit-outline"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="text-md-end footer-links d-none d-md-block">
                                    <a href="https://rolasmedika.co.id/"><i class=" uil-globe me-1"></i>rolasmedika.co.id</a>
        ...
        <!-- END wrapper -->
        <div id="addunitkerja" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">

            <div class="modal-body">
                <div class="text-center mt-2 mb-4">
                        <span><h3 alt="" height="18"> Tambah Unit Kerja </h3></span>
                </div>

                <form class="ps-3 pe-3" action="/addunitkerja" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="text" class="form-label">Kode</label>
                        <input type="hidden" value="<?= session('data')->id ?>" id='hidid' name="id_unit_usaha">
                        <select name="" class="form-select" aria-label="Default select example" disabled>
                            <option value="<?= session('data')->id ?>" ><?= session('data')->kode ?></option>
                    ...
                    <button type="submit" class="btn btn-sm btn-flat btn-primary"><i
...
<div id="editunitkerja" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="ps-3 pe-3" action="/editunitkerja" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="text" class="form-label">Kode</label>
...
<br>
    ...
    swal({
      ...
      if (isConfirm) {
        window.location.href = '/deleteunitkerja/'+id;
      } else {
      }
    })
            }
    ...
    $(this).on("click", function () {
        ...
        document.getElementById('id_unit_usahaedit').value = $(this).data('kode');
        document.getElementById('id_unit_usahaedit').innerHTML = $(this).data('kode');
