    ...
    public function collection()
    {
        if (session('data')->id == '1') {
            $users = DB::table('users')
                ...
                ->select('*', 'bidang.id as bidangid', 'inventaris_peralatanlift.id_petugas2 as idusaha', 'inventaris_peralatanlift.id_petugas2 as idusaha', 'unit_kerja.id as idkerja', 'users.id as id_user',  'unit_kerja.name as namakerja', 'users.name as usernamanya', 'bidang.name as bidangnama', 'petugas.name as petugasnama', 'petugas.id as idpetugas')
                ->get();
