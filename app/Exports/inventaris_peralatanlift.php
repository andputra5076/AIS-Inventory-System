...
class inventaris_peralatanlift implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithEvents, WithTitle
{
    use Exportable;
    ...
    public function collection()
    {
        if (session('data')->id == '1') {
            $users = DB::table('users')
                ...
                ->select('*', 'ruangan.id as ruanganid', 'inventaris_peralatanlift.id_petugas2 as idusaha', 'inventaris_peralatanlift.id_petugas2 as idusaha', 'unit_kerja.id as idkerja', 'users.id as id_user',  'unit_kerja.name as namakerja', 'users.name as usernamanya', 'ruangan.name as ruangannama', 'petugas.name as petugasnama', 'petugas.id as idpetugas')
                ->get();
    ...
    {
        return 'Inventaris Peralatan Lift';
    }
}
