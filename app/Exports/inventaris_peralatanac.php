...
class inventaris_peralatanac implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithEvents, WithTitle
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        foreach ($users as $user) {
            ...
            $spesifikasi = $user->spesifikasi_peralatanac;
    ...
    {
        return 'Inventaris Peralatan AC';
    }
}
