...
class aset_gedungdanbangunan implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithEvents, WithTitle
{
    use Exportable;
    ...
    {
        return 'Inventaris Aset Gedung dan Bangunan';
    }
}
