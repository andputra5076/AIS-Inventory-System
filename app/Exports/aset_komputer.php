...
class aset_komputer implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithEvents, WithTitle
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        foreach ($users as $user) {
            ...
            $spesifikasi = $user->spesifikasi_komputer;
